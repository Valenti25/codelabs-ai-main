...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function resizeCanvas() {
      const containerRect = container.getBoundingClientRect();
      const width = scaleByPixelRatio(containerRect.width);
      const height = scaleByPixelRatio(containerRect.height);
    ...
    function updatePointerDownData(
      ...
      pointer.down = true;
      pointer.moved = false;
      pointer.texcoordX = (posX - containerRect.left) / containerRect.width;
      pointer.texcoordY = 1 - (posY - containerRect.top) / containerRect.height;
    ...
    window.addEventListener("mousedown", (e) => {
     ...
     const posX = e.clientX;
      ...
      if (
        ...
        posX <= containerRect.right &&
        posY >= containerRect.top &&
        posY <= containerRect.bottom
      ) {
